...
export default function SidePanel(props: { lat: number; lon: number }) {
  return (
    <div className="fixed z-20 top-0 right-0 h-screen w-[var(--sidebar-width)] bg-background flex flex-col gap-6 p-4 translate-x-full sm:translate-x-0 transition-transform duration-300">
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <h1>{airPollutionData.list[0].main.aqi}</h1>
        <h1>AQI</h1>
      </div>
